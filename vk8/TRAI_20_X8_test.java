...
public class TRAI_20_X8_test {
    ...
    public static void main(String[] args) {
        ...
        // testattava rengas
        TRAI_20_X8<Integer> R = new TRAI_20_X8_tommpuur<>(); // oma tunnus tÃ¤hÃ¤n
        ...
        if (ok)
            System.out.println("\nX8, 32 ja 33 testit ok.");
        else
            System.out.println("\nX8, 32 tai 33 testeissÃ¤ ongelm(i)a.");
