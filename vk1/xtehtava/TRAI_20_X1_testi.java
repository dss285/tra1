...
/**
 * Testausluokka TRA I 2020 tehtÃ¤vÃ¤Ã¤n X1.
 */
public class TRAI_20_X1_testi {

    static Random rnd = new Random();

    static TRAI_20_X1 testattava = new TRAI_20_X1_tommpuur(); /* <-- Oma tunnus tÃ¤hÃ¤n */
    ...
    public static void main(String[] args) {
        ...
        ok &= testaaTulosX1(0, 0, false, print);
        ok &= testaaTulosX1(1, 0, false, print);
        ...
        ok &= testaaTulosX1(4, 0, false, print);
     ...
     * @param duplikaatteja laitetaanko syÃ¶tteeseen duplikaatteja vai ei
    ...
    static boolean testaaTulosX1(int n, int min, boolean duplikaatteja, int print) {
        ...
        if (print > 1 && (tulos == duplikaatteja) && sisaltoSailynyt)
            System.out.println("Testi ok");

        return (tulos == duplikaatteja) && sisaltoSailynyt;
