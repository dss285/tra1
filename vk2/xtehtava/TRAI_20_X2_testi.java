 ...
 */
public class TRAI_20_X2_testi {

    static Random rnd = new Random();

    static TRAI_20_X2 testattava = new TRAI_20_X2_tommpuur(); /* <-- Oma tunnus tÃ¤hÃ¤n */
    ...
    static boolean testaaTulosX2(int n1, int n2, int min1, int min2,
        ...
        ArrayList<Integer> tul = testattava.kasvavienYhdiste(A, B);
    ...
    static public boolean onkoUniikitAlkiot(ArrayList<Integer> A, int print) {
        ...
        if (print > 1)
            System.out.println("Uniikit alkiot ok");
        return true;
    }
